...
/**
 * Adapted from https://github.com/mjg123/java-http-clients/blob/master/src/main/java/com/twilio/JsonBodyHandler.java
 *
 * @param <T> Generic for the targetClass to be handled
 */
